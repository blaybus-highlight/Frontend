import { API_BASE_URL, BackOfficeSignUpResponse, BackOfficeSignUpRequest } from '@/types/api';
 ...
 */
export const signUpAdmin = async (credentials: BackOfficeSignUpRequest): Promise<BackOfficeSignUpResponse> => {
